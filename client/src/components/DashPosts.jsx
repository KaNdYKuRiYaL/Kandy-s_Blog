            ...
            {userPosts.map((post)=>(
              <Table.Body className='divide-y text-md'>
                ...
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                  ...
                  <Table.Cell>
                    <Link className='font-medium text-gray-900 dark:text-white' to={`/post/${post.title}`}> {post.title}</Link>       
                  </Table.Cell>
        ...
        size='md'>
          <Modal.Header/>
            <Modal.Body>
              ...
              <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are your sure you want to delete this post?</h3>
